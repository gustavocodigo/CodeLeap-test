...
function PostCard(props) {
    return <div className="post-card">
        <header id="component-header">
            ...
            {
                (props.editable) && <div id="postcard-edit-icons-container">
                    <svg width="32" height="30" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="postcard-icon">
        ...
        <div id="username-and-time-component">
            <p>@{props.username}</p>
            <p>25 minutes ago</p>
        </div>
